...
function setBotResponse(response) {
  ...
  setTimeout(function () {
    ...
    if (response.length < 1) {
      ...
      var fallbackMsg = "I'm having some problems, if this happens again, click on the three dots and restart!";

      var BotResponse =
        '<img class="botAvatar" src="./static/img/botAvatar_old.png"/><p class="botMsg">' +
        fallbackMsg +
        '</p><div class="clearfix"></div>';
...
function showBotTyping() {
  var botTyping =
    '<img class="botAvatar" id="botAvatar" src="./static/img/botAvatar_old.png"/><div class="botTyping">' +
