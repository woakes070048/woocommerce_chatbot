...
edited css/style.css
edited js/script.jshttp://95.216.202.18/ecommerce_chatbot/sample.html
edited widget.html
edited the integrated iframe code "<div style="position: fixed; bottom: 24px; right: 24px; width: 750px; height: 550px; z-index: 9999;">" and added in sample.html and also added the image of how to integrate the iframe tag in a website.http://95.216.202.18/ecommerce_chatbot/sample.html
-->
